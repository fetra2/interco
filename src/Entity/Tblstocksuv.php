...
use App\Repository\TblstocksuvRepository;
use Doctrine\ORM\Mapping as ORM;

/**
 * @ORM\Entity(repositoryClass=TblstocksuvRepository::class)
 */
class Tblstocksuv
{
    /**
    ...
    public function getStiqte(): ?float
    {
        return $this->stiqte;
    }

    public function setStiqte(?float $stiqte): self
    {
        $this->stiqte = $stiqte;
    ...
    public function getOrqte(): ?float
    {
        return $this->orqte;
    }

    public function setOrqte(?float $orqte): self
    {
        $this->orqte = $orqte;
    ...
    public function getOsvteqte(): ?float
    {
        return $this->osvteqte;
    }

    public function setOsvteqte(?float $osvteqte): self
    {
    ...
    public function getOsauqte(): ?float
    {
        return $this->osauqte;
    }

    public function setOsauqte(?float $osauqte): self
    {
    ...
    public function getStfqte(): ?float
    {
        return $this->stfqte;
    }

    public function setStfqte(?float $stfqte): self
    {
        $this->stfqte = $stfqte;
